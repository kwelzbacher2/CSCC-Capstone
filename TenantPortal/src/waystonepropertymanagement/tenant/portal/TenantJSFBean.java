...
//import javax.faces.bean.RequestScoped; // default import
//import javax.enterprise.context.RequestScoped; // what I'm supposed to have
//import javax.inject.Named; // what I'm supposed to have
 ...
 * @author Roxanne
 */
// @Named(value = "tenant") // what I'm supposed to have
...
public class TenantJSFBean implements Serializable {
	...
	public String updateEmployeeDetails(Tenant updateTenantObj) {
